-- Deep unsent letters for North Macedonia — Macedonian & Albanian names, real emotional weight
-- Replaces all demo content. Run: npm run seed:letters

-- Hide test / smoke posts (keeps rows, removes from wall)
UPDATE experiences SET status = 'rejected'
WHERE status = 'pending'
   OR title ILIKE 'smoke test%'
   OR title ILIKE 'test pending%'
   OR title = 'Nick test';
...
UPDATE experiences SET
  ...
  story = 'Markovi Kuli turned gold that evening and you told me about the year the harvest failed, how your mother hid bread in the mattress. I thought old stories were far away until they were not. You died in February before the trees woke up. I brought apples to the grave last autumn and could not finish them. Dad says grief is private. I think grief is public and we just pretend otherwise in Prilep.',
  author_mode = 'anonymous',
  author_name = NULL,
  image_url = NULL,
  memory_date = '1998-09-14'
WHERE id = '79a47a7b-11d3-4d41-847c-9a7fc72d829f';
...
UPDATE experiences SET
  ...
  story = 'I was seventeen, pockets empty after helping my sister with rent. Your shop smelled of paper and the cinnamon tea you always offered but never charged for. I stood too long with a thin poetry book and you said take it, pay when life is kinder. I paid you seven years later and you had already closed the shop. The book is on my nightstand in Skopje. I read the same poem when I want to remember that Štip once felt like mercy.',
  author_mode = 'anonymous',
  author_name = NULL,
  image_url = NULL,
  memory_date = '2012-11-03'
WHERE id = '5161a7a4-66bb-4f43-b709-9f85b5ed7580';

-- ─── Skopje Old Bazaar burek ───
UPDATE experiences SET
...
UPDATE experiences SET
  ...
  story = 'The last bus left without us near Debar Maalo and we decided walking to Aerodrom at two in the morning was wisdom. You carried my shoes when the blisters broke. Simona lied to her parents on the phone and said we were at a study group. Viktor quoted poetry badly and we laughed until the Vardar sounded like applause. That night we promised to show up for each other. Life scattered us — Zurich, Dubai, a village near Strumica. I am writing to say the promise still stands on my side.',
  author_mode = 'anonymous',
  author_name = NULL,
  image_url = NULL,
  memory_date = '2015-12-31'
WHERE id = '492b71ae-e13d-4ad7-84ff-5c9a96e680cc';
